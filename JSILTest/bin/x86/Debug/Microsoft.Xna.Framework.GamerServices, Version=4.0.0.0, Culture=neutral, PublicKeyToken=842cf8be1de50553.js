...
(function UnsafeNativeMethods$Members () {
  var $, $thisType;
  JSIL.MakeStaticClass("Microsoft.Xna.Framework.GamerServices.UnsafeNativeMethods", false, [], function ($interfaceBuilder) {
    $ = $interfaceBuilder;
    ...
    $.ExternalMethod({Static:true , Public:true }, "CreateFileMapping", 
      new JSIL.MethodSignature($asm06.TypeRef("System.IntPtr"), [
          $asm06.TypeRef("System.IntPtr"), $jsilcore.TypeRef("JSIL.Pointer", [$asm03.TypeRef("Microsoft.Xna.Framework.GamerServices.UnsafeNativeMethods+SecurityAttributes")]), 
          $.Int32, $.Int32, 
          $.Int32, $.String
        ], [])
    );
