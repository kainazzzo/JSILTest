...
var $asm04 = JSIL.DeclareAssembly("Microsoft.Xna.Framework.GamerServices, Version=4.0.0.0, Culture=neutral, PublicKeyToken=842cf8be1de50553");
...
(function SignedInEventArgs$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamer")], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "get_Gamer", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamer"), [], [])
    );

    $.Field({Static:false, Public:false}, "gamer", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamer")); 
    $.Property({Static:false, Public:true }, "Gamer", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamer"));
...
(function InviteAcceptedEventArgs$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamer"), $.Boolean], [])
    );
...
(function Gamer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:true }, "EndGetPartnerToken", 
      new JSIL.MethodSignature($.String, [$asm07.TypeRef("System.IAsyncResult")], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "EndGetProfile", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerProfile"), [$asm07.TypeRef("System.IAsyncResult")], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_LeaderboardWriter", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardWriter"), [], [])
    );

    $.ExternalMethod({Static:true , Public:true }, "get_SignedInGamers", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamerCollection"), [], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "GetProfile", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerProfile"), [], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "ValidateGamerList", 
      new JSIL.MethodSignature($.Int32, [
          $asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$.Type]), $.Int32, 
          $.Int32, $.String
        ], [])
    );
    ...
    $.Field({Static:true , Public:false}, "signedInGamers", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamerCollection")); 
    ...
    $.Property({Static:true , Public:true }, "SignedInGamers", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamerCollection"));

    $.Property({Static:false, Public:true }, "LeaderboardWriter", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardWriter"));
...
(function FriendGamer$Members () {
  var $, $thisType;
  JSIL.MakeType({
      BaseType: $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer"), 
    ...
    $.ExternalMethod({Static:false, Public:false}, ".ctor", 
      new JSIL.MethodSignature(null, [
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.FriendCollection"), $.String, 
          $.String, $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.FriendState")
        ], [])
    );
    ...
    $.Field({Static:false, Public:false}, "parent", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.FriendCollection")); 
    $.Field({Static:false, Public:false}, "presence", $.String); 
    $.Field({Static:false, Public:false}, "friendState", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.FriendState")); 
...
(function InternalIndexComparer$b1$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm07.TypeRef("System.Collections.Generic.IComparer`1", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.InternalIndexComparer`1")])
    );
...
(function GamerCollection$b1$Members () {
  var $, $thisType;
  JSIL.MakeType({
      BaseType: $asm07.TypeRef("System.Collections.ObjectModel.ReadOnlyCollection`1", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.GamerCollection`1")]), 
    ...
    $.ExternalMethod({Static:false, Public:true }, "GetEnumerator", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerCollection`1+GamerCollectionEnumerator", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.GamerCollection`1")]), [], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerable$lMicrosoft.Xna.Framework.GamerServices.Gamer$g.GetEnumerator", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")]), [], [])
    )
      .Overrides(6, "GetEnumerator");

    $.Field({Static:false, Public:false}, "wrappedList", $asm07.TypeRef("System.Collections.Generic.List`1", [$.GenericParameter("T")])); 
    $.Field({Static:true , Public:false}, "internalIndexComparer", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.InternalIndexComparer`1", [$.GenericParameter("T")])); 
    function GamerCollection$b1__cctor () {
      $thisType.internalIndexComparer = new ($asm04.Microsoft.Xna.Framework.GamerServices.InternalIndexComparer$b1.Of($thisType.T.get(this))) ();
    };
    ...
    $.ImplementInterfaces(
      /* 8 */ $asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")]), 
...
(function GamerCollectionEnumerator$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, ".ctor", 
      new JSIL.MethodSignature(null, [$asm07.TypeRef("System.Collections.Generic.List`1+Enumerator", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.GamerCollection`1/GamerCollectionEnumerator")])], [])
    );
    ...
    $.Field({Static:false, Public:false}, "internalEnumerator", $asm07.TypeRef("System.Collections.Generic.List`1+Enumerator", [$.GenericParameter("T")])); 
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm07.TypeRef("System.Collections.Generic.IEnumerator`1", [new JSIL.GenericParameter("T", "Microsoft.Xna.Framework.GamerServices.GamerCollection`1/GamerCollectionEnumerator")]), 
...
(function GetEnumerator$gd__0$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerator$lMicrosoft.Xna.Framework.GamerServices.Gamer$g.get_Current", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer"), [], [])
    )
    ...
    $.Field({Static:false, Public:false}, "$current", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")); 
    $.Field({Static:false, Public:false}, "$state", $.Int32); 
    $.Field({Static:false, Public:true }, "$this", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerCollection`1", [$.GenericParameter("T")])); 
    $.Field({Static:false, Public:true }, "gamer", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")); 
    $.Field({Static:false, Public:true }, "$wrap2", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerCollection`1+GamerCollectionEnumerator", [$.GenericParameter("T")])); 
    $.Property({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerator$lMicrosoft.Xna.Framework.GamerServices.Gamer$g.Current", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer"));

    $.Property({Static:false, Public:false, Virtual:true }, "System.Collections.IEnumerator.Current", $.Object);

    $.ImplementInterfaces(
      /* 0 */ $asm07.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")]), 
...
(function GamerPrivileges$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, ".ctor", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivilegeOptions")], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "get_AllowCommunication", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivilegeSetting"), [], [])
    );
    ...
    $.Field({Static:false, Public:false}, "privileges", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivilegeOptions")); 
    $.Property({Static:false, Public:true }, "AllowOnlineSessions", $.Boolean);

    $.Property({Static:false, Public:true }, "AllowCommunication", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivilegeSetting"));

    $.Property({Static:false, Public:true }, "AllowProfileViewing", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivilegeSetting"));

    $.Property({Static:false, Public:true }, "AllowUserCreatedContent", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivilegeSetting"));
...
(function PlayerState$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "SignInState", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.PlayerSignInState")); 
    $.Field({Static:false, Public:false}, "Gamertag", $.String); 
    $.Field({Static:false, Public:false}, "IsLive", $.Boolean); 
    $.Field({Static:false, Public:false}, "IsGuest", $.Boolean); 
    $.Field({Static:false, Public:false}, "Privileges", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivilegeOptions")); 
    $.Field({Static:false, Public:false}, "GameDefaults", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GameDefaults")); 
...
(function SignedInGamerCollection$Members () {
  var $, $thisType;
  JSIL.MakeType({
      BaseType: $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerCollection`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamer")]), 
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_Item", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamer"), [$asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex")], [])
    );

    $.Property({Static:false, Public:true }, "Item", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInGamer"));
...
(function UserPacketBuffer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "StealSpaceFromEndOfBuffer", 
      new JSIL.MethodSignature($asm07.TypeRef("System.IntPtr"), [$.Int32], [])
    );
    ...
    $.Field({Static:false, Public:false}, "Data", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SharedMemoryRegion")); 
...
(function AchievementCollection$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, ".ctor", 
      new JSIL.MethodSignature(null, [$asm07.TypeRef("System.Collections.Generic.List`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")])], [])
    );

    $.ExternalMethod({Static:true , Public:false}, "CompareAchievements", 
      new JSIL.MethodSignature($.Int32, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement"), $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_Item", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement"), [$.Int32], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "get_Item", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement"), [$.String], [])
    );

    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "GetEnumerator", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), [], [])
    );

    $.ExternalMethod({Static:true , Public:false}, "RateAchievement", 
      new JSIL.MethodSignature($.Int32, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.ICollection$lMicrosoft.Xna.Framework.GamerServices.Achievement$g.Add", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")], [])
    )
      .Overrides(1, "Add");
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.ICollection$lMicrosoft.Xna.Framework.GamerServices.Achievement$g.Contains", 
      new JSIL.MethodSignature($.Boolean, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")], [])
    )
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.ICollection$lMicrosoft.Xna.Framework.GamerServices.Achievement$g.CopyTo", 
      new JSIL.MethodSignature(null, [$jsilcore.TypeRef("System.Array", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), $.Int32], [])
    )
      .Overrides(1, "CopyTo");
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IList$lMicrosoft.Xna.Framework.GamerServices.Achievement$g.Insert", 
      new JSIL.MethodSignature(null, [$.Int32, $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")], [])
    )
      .Overrides(0, "Insert");
    ...
    $.Field({Static:false, Public:false}, "achievements", $asm07.TypeRef("System.Collections.Generic.List`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")])); 
    $.Field({Static:false, Public:false}, "achievementDictionary", $asm07.TypeRef("System.Collections.Generic.Dictionary`2", [$.String, $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")])); 
    $.Field({Static:false, Public:false}, "isDisposed", $.Boolean); 
    $.Property({Static:false, Public:true }, "IsDisposed", $.Boolean);

    $.Property({Static:false, Public:true }, "Item", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement"));

    $.Property({Static:false, Public:true }, "Item", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement"));

    $.Property({Static:false, Public:true , Virtual:true }, "Count", $.Int32);

    $.Property({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IList$lMicrosoft.Xna.Framework.GamerServices.Achievement$g.Item", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement"));
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm07.TypeRef("System.Collections.Generic.IList`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), 
      /* 1 */ $asm07.TypeRef("System.Collections.Generic.ICollection`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), 
      /* 2 */ $asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Achievement")]), 
...
(function PropertyDictionary$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "GetEnumerator", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm07.TypeRef("System.Collections.Generic.KeyValuePair`2", [$.String, $.Object])]), [], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "GetValueOutcome", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardOutcome"), [$.String], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "SetValue", 
      new JSIL.MethodSignature(null, [$.String, $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardOutcome")], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.ICollection$lSystem.Collections.Generic.KeyValuePair$lSystem.String$cmSystem.Object$g$g.Add", 
      new JSIL.MethodSignature(null, [$asm07.TypeRef("System.Collections.Generic.KeyValuePair`2", [$.String, $.Object])], [])
    )
      .Overrides(1, "Add");
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IDictionary$lSystem.String$cmSystem.Object$g.get_Keys", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Collections.Generic.ICollection`1", [$.String]), [], [])
    )
    ...
    $.ExternalMethod({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IDictionary$lSystem.String$cmSystem.Object$g.get_Values", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Collections.Generic.ICollection`1", [$.Object]), [], [])
    )
...
(function LeaderboardIdentity$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:true }, "Create", 
      new JSIL.MethodSignature($.Type, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardKey"), $.Int32], [])
    );

    $.ExternalMethod({Static:true , Public:true }, "Create", 
      new JSIL.MethodSignature($.Type, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardKey")], [])
    );
...
(function LeaderboardReader$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginRead", 
      new JSIL.MethodSignature($asm07.TypeRef("System.IAsyncResult"), [
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardIdentity"), $asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")]), 
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer"), $.Int32, 
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginRead", 
      new JSIL.MethodSignature($asm07.TypeRef("System.IAsyncResult"), [
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardIdentity"), $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer"), 
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginRead", 
      new JSIL.MethodSignature($asm07.TypeRef("System.IAsyncResult"), [
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardIdentity"), $.Int32, 
          $.Int32, $asm07.TypeRef("System.AsyncCallback"), 
          $.Object
        ], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "EndPageDown", 
      new JSIL.MethodSignature(null, [$asm07.TypeRef("System.IAsyncResult")], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_Entries", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Collections.ObjectModel.ReadOnlyCollection`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardEntry")]), [], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_LeaderboardIdentity", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardIdentity"), [], [])
    );
    ...
    $.Property({Static:false, Public:true }, "LeaderboardIdentity", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardIdentity"));

    $.Property({Static:false, Public:true }, "TotalLeaderboardSize", $.Int32);

    $.Property({Static:false, Public:true }, "PageStart", $.Int32);

    $.Property({Static:false, Public:true }, "Entries", $asm07.TypeRef("System.Collections.ObjectModel.ReadOnlyCollection`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardEntry")]));
...
(function LeaderboardEntry$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_Columns", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.PropertyDictionary"), [], [])
    );
    ...
    $.Property({Static:false, Public:true }, "Gamer", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer"));

    $.Property({Static:false, Public:true }, "Rating", $.Int64);

    $.Property({Static:false, Public:true }, "Columns", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.PropertyDictionary"));
...
(function Guide$Members () {
  ...
  JSIL.MakeStaticClass("Microsoft.Xna.Framework.GamerServices.Guide", true, [], function ($interfaceBuilder) {
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginShowKeyboardInput", 
      new JSIL.MethodSignature($asm07.TypeRef("System.IAsyncResult"), [
          $asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), $.String, 
          $.String, $.String, 
          $asm07.TypeRef("System.AsyncCallback"), $.Object
        ], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginShowMessageBox", 
      new JSIL.MethodSignature($asm07.TypeRef("System.IAsyncResult"), [
          ...
          $.Int32, $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.MessageBoxIcon"), 
          $asm07.TypeRef("System.AsyncCallback"), $.Object
        ], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "BeginShowMessageBox", 
      new JSIL.MethodSignature($asm07.TypeRef("System.IAsyncResult"), [
          $.String, $.String, 
          $asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$.String]), $.Int32, 
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.MessageBoxIcon"), $asm07.TypeRef("System.AsyncCallback"), 
          $.Object
        ], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "EndShowMessageBox", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Nullable`1", [$.Int32]), [$asm07.TypeRef("System.IAsyncResult")], [])
    );

    $.ExternalMethod({Static:true , Public:false}, "ExecuteKernelCall", 
      new JSIL.MethodSignature(null, [
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.KernelCallType"), $asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), 
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")
        ], [])
    );

    $.ExternalMethod({Static:true , Public:false}, "ExecuteKernelCall", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.KernelCallType"), $asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex")], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "get_NotificationPosition", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.NotificationPosition"), [], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "set_NotificationPosition", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.NotificationPosition")], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "ShowComposeMessage", 
      new JSIL.MethodSignature(null, [
          $asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), $.String, 
          $asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")])
        ], [])
    );

    $.ExternalMethod({Static:true , Public:true }, "ShowFriendRequest", 
      new JSIL.MethodSignature(null, [$asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")], [])
    );

    $.ExternalMethod({Static:true , Public:true }, "ShowFriends", 
      new JSIL.MethodSignature(null, [$asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex")], [])
    );

    $.ExternalMethod({Static:true , Public:true }, "ShowGameInvite", 
      new JSIL.MethodSignature(null, [$asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), $asm07.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")])], [])
    );
    ...
    $.Field({Static:true , Public:false}, "notificationPosition", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.NotificationPosition"), function ($pi) {
        return $asm04.Microsoft.Xna.Framework.GamerServices.NotificationPosition.BottomCenter;
      }); 
    ...
    $.Property({Static:true , Public:true }, "NotificationPosition", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.NotificationPosition"));
...
(function KernelMethods$Members () {
  ...
  JSIL.MakeStaticClass("Microsoft.Xna.Framework.GamerServices.KernelMethods", false, [], function ($interfaceBuilder) {
    ...
    $.ExternalMethod({Static:true , Public:true }, "DispatchCommand", 
      new JSIL.MethodSignature($.UInt32, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.UserPacketBuffer")], [])
    );
    ...
    $.Field({Static:true , Public:false}, "proxyProcess", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.KernelMethods+ProxyProcess")); 
...
(function ProxyProcess$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, ".ctor", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.UserPacketBuffer")], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "get_AsyncManagedCallType", 
      new JSIL.MethodSignature($asm02.TypeRef("Microsoft.Xna.Framework.ManagedCallType"), [], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "SafeCloseHandle", 
      new JSIL.MethodSignature(null, [$jsilcore.TypeRef("JSIL.Reference", [$asm07.TypeRef("System.IntPtr")])], [])
    );
    ...
    $.Field({Static:false, Public:false}, "triggerCallEvent", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "callDoneEvent", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "proxyProcessWantsToTalk", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "sharedAsyncDataSafeToWrite", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "aSyncHResultPtr", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "asyncManagedCallArgument", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "aSyncManagedCallTypePtr", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "parentExitEvent", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "serverProcess", $asm08.TypeRef("System.Diagnostics.Process")); 
    $.Field({Static:false, Public:false}, "isDisposed", $.Boolean); 
    $.Field({Static:true , Public:false}, "virtualTitleId", $asm07.TypeRef("System.Nullable`1", [$asm07.TypeRef("System.Guid")])); 
    function ProxyProcess__cctor () {
      $thisType.virtualTitleId = new ($asm07.System.Nullable$b1.Of($asm07.System.Guid)) ();
    };
    ...
    $.Property({Static:false, Public:true , Virtual:true }, "ProxyProcessWantsToTalk", $asm07.TypeRef("System.IntPtr"));

    $.Property({Static:false, Public:true , Virtual:true }, "SharedAsyncDataSafeToWrite", $asm07.TypeRef("System.IntPtr"));
    ...
    $.Property({Static:false, Public:true , Virtual:true }, "AsyncManagedCallType", $asm02.TypeRef("Microsoft.Xna.Framework.ManagedCallType"));

    $.Property({Static:true , Public:false}, "VirtualTitleId", $asm07.TypeRef("System.Guid"));

    $.ImplementInterfaces(
      /* 0 */ $asm07.TypeRef("System.IDisposable"), 
      /* 1 */ $asm02.TypeRef("Microsoft.Xna.Framework.IProxyProcessHandler")
    );
...
(function SharedMemoryRegion$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "fileHandle", $asm07.TypeRef("System.IntPtr")); 
    $.Field({Static:false, Public:false}, "mappedPointer", $asm07.TypeRef("System.IntPtr")); 
    $.Property({Static:false, Public:true }, "Size", $.Int32);

    $.Property({Static:false, Public:true }, "FileHandle", $asm07.TypeRef("System.IntPtr"));

    $.Property({Static:false, Public:true }, "MappedPointer", $asm07.TypeRef("System.IntPtr"));
...
(function FriendCollection$Members () {
  var $, $thisType;
  JSIL.MakeType({
      BaseType: $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerCollection`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.FriendGamer")]), 
    ...
    $.ImplementInterfaces(
      /* 10 */ $asm07.TypeRef("System.IDisposable")
    );
...
(function NetworkNotAvailableException$Members () {
  var $, $thisType;
  JSIL.MakeType({
      BaseType: $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.NetworkException"), 
...
(function GameDefaults$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_ControllerSensitivity", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.ControllerSensitivity"), [], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "get_GameDifficulty", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GameDifficulty"), [], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_PrimaryColor", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Nullable`1", [$asm02.TypeRef("Microsoft.Xna.Framework.Color")]), [], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "get_RacingCameraAngle", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.RacingCameraAngle"), [], [])
    );
    ...
    $.Field({Static:false, Public:false}, "gameDifficulty", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GameDifficulty")); 
    $.Field({Static:false, Public:false}, "controllerSensitivity", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.ControllerSensitivity")); 
    $.Field({Static:false, Public:false}, "primaryColor", $asm07.TypeRef("System.Nullable`1", [$asm02.TypeRef("Microsoft.Xna.Framework.Color")])); 
    $.Field({Static:false, Public:false}, "secondaryColor", $asm07.TypeRef("System.Nullable`1", [$asm02.TypeRef("Microsoft.Xna.Framework.Color")])); 
    ...
    $.Field({Static:false, Public:false}, "racingCameraAngle", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.RacingCameraAngle")); 
    $.Field({Static:false, Public:false}, "accelerateWithButtons", $.Boolean); 
    $.Field({Static:false, Public:false}, "brakeWithButtons", $.Boolean); 
    $.Property({Static:false, Public:true }, "GameDifficulty", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GameDifficulty"));

    $.Property({Static:false, Public:true }, "ControllerSensitivity", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.ControllerSensitivity"));

    $.Property({Static:false, Public:true }, "PrimaryColor", $asm07.TypeRef("System.Nullable`1", [$asm02.TypeRef("Microsoft.Xna.Framework.Color")]));

    $.Property({Static:false, Public:true }, "SecondaryColor", $asm07.TypeRef("System.Nullable`1", [$asm02.TypeRef("Microsoft.Xna.Framework.Color")]));
    ...
    $.Property({Static:false, Public:true }, "RacingCameraAngle", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.RacingCameraAngle"));
...
(function GamerPresence$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_PresenceMode", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPresenceMode"), [], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "set_PresenceMode", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPresenceMode")], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:false}, "WriteChanges", 
      new JSIL.MethodSignature(null, [
          $asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.UserPacketBuffer"), 
          $jsilcore.TypeRef("JSIL.Pointer", [$.Byte])
        ], [])
    );

    $.Field({Static:false, Public:false}, "presenceMode", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPresenceMode")); 
    $.Field({Static:false, Public:false}, "presenceValue", $.Int32); 
    $.Field({Static:false, Public:false}, "presenceChanged", $.Boolean); 
    $.Property({Static:false, Public:true }, "PresenceMode", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPresenceMode"));
...
(function GamerProfile$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_GamerZone", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerZone"), [], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_Region", 
      new JSIL.MethodSignature($asm07.TypeRef("System.Globalization.RegionInfo"), [], [])
    );
    ...
    $.Field({Static:false, Public:false}, "gamerZone", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerZone")); 
    $.Field({Static:false, Public:false}, "region", $asm07.TypeRef("System.Globalization.RegionInfo")); 
    ...
    $.Field({Static:false, Public:false}, "pictureData", $jsilcore.TypeRef("System.Array", [$asm02.TypeRef("Microsoft.Xna.Framework.Color")])); 
    $.Property({Static:false, Public:true }, "IsDisposed", $.Boolean);
    ...
    $.Property({Static:false, Public:true }, "GamerZone", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerZone"));

    $.Property({Static:false, Public:true }, "Region", $asm07.TypeRef("System.Globalization.RegionInfo"));
...
(function GamerServicesDispatcher$Members () {
  ...
  JSIL.MakeStaticClass("Microsoft.Xna.Framework.GamerServices.GamerServicesDispatcher", true, [], function ($interfaceBuilder) {
    ...
    $.ExternalMethod({Static:true , Public:false}, "add_InviteAccepted", 
      new JSIL.MethodSignature(null, [$asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.InviteAcceptedEventArgs")])], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "get_PacketBuffer", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.UserPacketBuffer"), [], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "OnInviteAccepted", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.InviteAcceptedEventArgs")], [])
    );
    ...
    $.Field({Static:true , Public:false}, "serviceProvider", $asm07.TypeRef("System.IServiceProvider")); 
    $.Field({Static:true , Public:false}, "packetBuffer", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.UserPacketBuffer")); 
    $.Field({Static:true , Public:false}, "playerStates", $jsilcore.TypeRef("System.Array", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.PlayerState")]), function ($pi) {
        return JSIL.Array.New($asm04.Microsoft.Xna.Framework.GamerServices.PlayerState, 4);
      }); 
    $.Field({Static:true , Public:false}, "changedPlayerIndices", $jsilcore.TypeRef("System.Array", [$.Int32]), function ($pi) {
        return JSIL.Array.New($asm07.System.Int32, 4);
      }); 
    $.Field({Static:true , Public:false}, "inviteAccepted", $asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.InviteAcceptedEventArgs")])); 
    $.Field({Static:true , Public:false}, "pendingInviteAccepted", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.InviteAcceptedEventArgs")); 
    $.Field({Static:true , Public:false}, "InstallingTitleUpdate", $asm07.TypeRef("System.EventHandler`1", [$asm07.TypeRef("System.EventArgs")])); 
    $.Field({Static:true , Public:false}, "guideMessageHooker", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GuideMessageHooker")); 
    $.Field({Static:true , Public:false}, "pendingWindowHandle", $asm07.TypeRef("System.IntPtr")); 
    $.Property({Static:true , Public:false}, "PacketBuffer", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.UserPacketBuffer"));
    ...
    $.Event({Static:true , Public:false}, "InviteAccepted", $asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.InviteAcceptedEventArgs")]));

    $.Event({Static:true , Public:true }, "InstallingTitleUpdate", $asm07.TypeRef("System.EventHandler`1", [$asm07.TypeRef("System.EventArgs")]));
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:false}, ".ctor", 
      new JSIL.MethodSignature(null, [
          $.Int32, $.String, 
          $.Boolean, $.Boolean, 
          $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GameDefaults"), $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivilegeOptions"), 
          $.Int32
        ], [])
    );

    $.ExternalMethod({Static:true , Public:false}, "add_signedIn", 
      new JSIL.MethodSignature(null, [$asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInEventArgs")])], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:true }, "add_SignedOut", 
      new JSIL.MethodSignature(null, [$asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedOutEventArgs")])], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "EndGetAchievements", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.AchievementCollection"), [$asm07.TypeRef("System.IAsyncResult")], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "get_GameDefaults", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GameDefaults"), [], [])
    );
    ...
    $.ExternalMethod({Static:false, Public:true }, "get_PlayerIndex", 
      new JSIL.MethodSignature($asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex"), [], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "get_Presence", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPresence"), [], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "get_Privileges", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivileges"), [], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "GetAchievements", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.AchievementCollection"), [], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "GetFriends", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.FriendCollection"), [], [])
    );

    $.ExternalMethod({Static:true , Public:false}, "HandlePlayerSignInChanged", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.PlayerState")], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "IsFriend", 
      new JSIL.MethodSignature($.Boolean, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.Gamer")], [])
    );

    $.ExternalMethod({Static:false, Public:true }, "IsHeadset", 
      new JSIL.MethodSignature($.Boolean, [$asm02.TypeRef("Microsoft.Xna.Framework.Audio.Microphone")], [])
    );
    ...
    $.ExternalMethod({Static:true , Public:false}, "WritePresenceChanges", 
      new JSIL.MethodSignature(null, [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.UserPacketBuffer"), $jsilcore.TypeRef("JSIL.Pointer", [$.Byte])], [])
    );

    $.Field({Static:false, Public:false}, "playerIndex", $asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex")); 
    $.Field({Static:false, Public:false}, "isSignedInToLive", $.Boolean); 
    $.Field({Static:false, Public:false}, "isGuest", $.Boolean); 
    $.Field({Static:false, Public:false}, "gameDefaults", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GameDefaults")); 
    $.Field({Static:false, Public:false}, "privileges", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivileges")); 
    $.Field({Static:false, Public:false}, "partySize", $.Int32); 
    $.Field({Static:true , Public:false}, "signedIn", $asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInEventArgs")])); 
    $.Field({Static:true , Public:false}, "SignedOut", $asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedOutEventArgs")])); 
    $.Field({Static:true , Public:false}, "cachedPlayerStates", $jsilcore.TypeRef("System.Array", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.PlayerState")]), function ($pi) {
        return JSIL.Array.New($asm04.Microsoft.Xna.Framework.GamerServices.PlayerState, 4);
      }); 
    $.Field({Static:false, Public:false}, "presence", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPresence")); 
    $.Property({Static:false, Public:true }, "PlayerIndex", $asm02.TypeRef("Microsoft.Xna.Framework.PlayerIndex"));

    $.Property({Static:false, Public:true }, "IsSignedInToLive", $.Boolean);

    $.Property({Static:false, Public:true }, "IsGuest", $.Boolean);

    $.Property({Static:false, Public:true }, "GameDefaults", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GameDefaults"));

    $.Property({Static:false, Public:true }, "Privileges", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPrivileges"));

    $.Property({Static:false, Public:true }, "PartySize", $.Int32);

    $.Property({Static:false, Public:true }, "Presence", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.GamerPresence"));

    $.Event({Static:true , Public:true }, "SignedIn", $asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInEventArgs")]));

    $.Event({Static:true , Public:false}, "signedIn", $asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedInEventArgs")]));

    $.Event({Static:true , Public:true }, "SignedOut", $asm07.TypeRef("System.EventHandler`1", [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.SignedOutEventArgs")]));
...
(function Achievement$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Property({Static:false, Public:true }, "EarnedDateTime", $asm07.TypeRef("System.DateTime"));
...
(function LeaderboardWriter$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true }, "GetLeaderboard", 
      new JSIL.MethodSignature($asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardEntry"), [$asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.LeaderboardIdentity")], [])
    );
...
(function GuideRendererProxySource$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm07.System.IServiceProvider)) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "drawCommandBuffer", $asm04.TypeRef("Microsoft.Xna.Framework.GamerServices.UserPacketBuffer")); 
    $.Field({Static:false, Public:false}, "GuideRendererProxySource$ServiceProvider$value", $asm07.TypeRef("System.IServiceProvider"))
      .Attribute($asm07.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute")); 
    $.Property({Static:false, Public:true , Virtual:true }, "ServiceProvider", $asm07.TypeRef("System.IServiceProvider"));

    $.ImplementInterfaces(
      /* 0 */ $asm02.TypeRef("Microsoft.Xna.Framework.GamerServices.IGuideRendererProxySource")
    );
